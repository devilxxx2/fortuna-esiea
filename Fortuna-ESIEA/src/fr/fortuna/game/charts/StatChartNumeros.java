...
public class StatChartNumeros extends ApplicationFrame{
	 ...
	 * 
	 * @param title 
	 * @param isNumero true si on affiche les num�ros, false si on affiche les �toiles
	 */
	public StatChartNumeros(String title, boolean isNumero){
		...
		// cr�ation du panel de diagramme
	...
	private JFreeChart createChart(CategoryDataset categorydataset) {
		...
		if(isNumero){
			jfreechart= ChartFactory
				.createBarChart("Fr�quence de sortie des num�ros", "Num�ros",
						"", categorydataset, PlotOrientation.HORIZONTAL, false,
						true, false);
		}else {
			jfreechart = ChartFactory.createBarChart("Fr�quence de sortie des �toiles", "Etoiles",
					"", categorydataset, PlotOrientation.HORIZONTAL, false,
					true, false);
		}
